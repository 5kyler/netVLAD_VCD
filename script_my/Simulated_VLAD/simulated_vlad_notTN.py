...
if __name__ == '__main__':
    ...
    dataset_dir = '/mldisk/nfs_shared_/my_vlad/simulated_features/5sec_segment_feature/400/sim_vlad'
    ...
    feature_path = '/mldisk/nfs_shared_/my_vlad/simulated_features/5sec_segment_feature/400/db_vlad'  # database
    ...
    transform_origin = ['border', 'resolution', 'framerate', 'brightness', 'crop', 'format', 'logo', 'rotate', 'flip',
                 'grayscale']
    transform = ['rotate', 'flip', 'border', 'logo']
    ...
    #             rank_list = []
    #             for v in video_list:
    #                 rank = test(topk=20, tn_param=[50, 2, 0.3], query_path=v)
    #
    #                 if rank != -1:
    #                     sum += 1
    #                     rank_sum += rank
    ...
    #
    query_path = '/mldisk/nfs_shared_/my_vlad/simulated_features/5sec_segment_feature/400/sim_vlad/flip/Light/0YyLQPTzuIk.flv.pth'
    print(test(topk=3, tn_param=[5, 2, 0.3], query_path=query_path))